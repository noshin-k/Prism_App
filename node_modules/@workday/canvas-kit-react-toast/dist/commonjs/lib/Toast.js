...
var ActionButton = styled_1.default('button')(__assign({ display: 'block', backgroundColor: 'transparent', border: 'none', padding: 0, marginTop: canvas_kit_react_core_1.spacing.xxxs }, canvas_kit_react_core_1.type.body2, canvas_kit_react_core_1.type.variant.link));
...
var Toast = (function (_super) {
    ...
    Toast.prototype.render = function () {
        var _a = this.props, onClose = _a.onClose, onActionClick = _a.onActionClick, actionText = _a.actionText, icon = _a.icon, iconColor = _a.iconColor, transformOrigin = _a.transformOrigin, elemProps = __rest(_a, ["onClose", "onActionClick", "actionText", "icon", "iconColor", "transformOrigin"]);
        var isInteractive = onClose || onActionClick;
        return (React.createElement(canvas_kit_react_popup_1.default, __assign({ width: toastWidth, transformOrigin: transformOrigin, padding: canvas_kit_react_popup_1.PopupPadding.s, handleClose: onClose, closeIconSize: canvas_kit_react_button_1.IconButtonSize.Small, role: isInteractive ? 'dialog' : 'status', "aria-live": isInteractive ? 'off' : 'polite', "aria-atomic": !isInteractive }, elemProps),
    ...
    Toast.defaultProps = {
        icon: canvas_system_icons_web_1.checkIcon,
        iconColor: canvas_kit_react_core_1.colors.greenApple400,
    };
    return Toast;
}(React.Component));
