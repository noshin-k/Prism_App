...
var Header = styled_1.default('h2')(__assign({}, canvas_kit_react_core_1.type.h2, { marginTop: canvas_kit_react_core_1.spacing.zero }));
...
var SidePanel = (function (_super) {
    ...
    function SidePanel(props) {
        ...
        _this.toggleButtonDirection = function () {
            if (_this.props.openDirection !== SidePanelOpenDirection.Right) {
                return _this.props.open ? canvas_system_icons_web_1.chevronLeftIcon : canvas_system_icons_web_1.chevronRightIcon;
            }
            else {
                return _this.props.open ? canvas_system_icons_web_1.chevronRightIcon : canvas_system_icons_web_1.chevronLeftIcon;
            }
        };
    ...
    SidePanel.prototype.render = function () {
        var _a = this.props, header = _a.header, onToggleClick = _a.onToggleClick, open = _a.open, openDirection = _a.openDirection, padding = _a.padding, onBreakpointChange = _a.onBreakpointChange, openWidth = _a.openWidth, backgroundColor = _a.backgroundColor, openNavigationLabel = _a.openNavigationLabel, closeNavigationLabel = _a.closeNavigationLabel, elemProps = __rest(_a, ["header", "onToggleClick", "open", "openDirection", "padding", "onBreakpointChange", "openWidth", "backgroundColor", "openNavigationLabel", "closeNavigationLabel"]);
        return (React.createElement(SidePanelContainer, __assign({ role: "region", padding: padding, openDirection: openDirection, openWidth: openWidth, backgroundColor: backgroundColor, open: open }, elemProps),
            React.createElement(ChildrenContainer, { open: open, openWidth: openWidth },
                ...
                this.props.children),
            React.createElement(SidePanelFooter, { openWidth: openWidth, open: open }, onToggleClick && (React.createElement(ToggleButton, { openDirection: openDirection, "aria-label": open ? closeNavigationLabel : openNavigationLabel, toggled: false, size: canvas_kit_react_button_1.IconButton.Size.Small, onClick: this.onToggleClick, icon: this.toggleButtonDirection(), variant: canvas_kit_react_button_1.IconButton.Variant.CircleFilled })))));
    };
