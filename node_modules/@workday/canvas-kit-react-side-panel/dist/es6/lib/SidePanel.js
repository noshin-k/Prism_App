...
var closedWidth = spacing.xxl;
var Header = styled('h2')(__assign({}, type.h2, { marginTop: spacing.zero }));
...
var ToggleButton = styled(IconButton)({
    position: 'absolute',
    bottom: spacing.s,
}, function (_a) {
    var openDirection = _a.openDirection;
...
var SidePanelFooter = styled('div')({
    position: 'absolute',
    bottom: '0',
    height: 120,
    left: 0,
    ...
    function SidePanel(props) {
        ...
        _this.toggleButtonDirection = function () {
            if (_this.props.openDirection !== SidePanelOpenDirection.Right) {
                return _this.props.open ? chevronLeftIcon : chevronRightIcon;
            }
            else {
                return _this.props.open ? chevronRightIcon : chevronLeftIcon;
            }
        };
    ...
    SidePanel.prototype.render = function () {
        ...
        return (React.createElement(SidePanelContainer, __assign({ role: "region", padding: padding, openDirection: openDirection, openWidth: openWidth, backgroundColor: backgroundColor, open: open }, elemProps),
            React.createElement(ChildrenContainer, { open: open, openWidth: openWidth },
                ...
                this.props.children),
            React.createElement(SidePanelFooter, { openWidth: openWidth, open: open }, onToggleClick && (React.createElement(ToggleButton, { openDirection: openDirection, "aria-label": open ? closeNavigationLabel : openNavigationLabel, toggled: false, size: IconButton.Size.Small, onClick: this.onToggleClick, icon: this.toggleButtonDirection(), variant: IconButton.Variant.CircleFilled })))));
    };
