...
exports.convertToStaticStates = function (obj) {
    ...
    return Object.keys(obj).reduce(function (result, key) {
        ...
        var newObj = __assign({}, result, (_a = {}, _a[newKey] = value, _a));
        return newObj;
    }, {});
};
function styled(node) {
    return function () {
        ...
        var newArgs = args.map(function (interpolation) { return function (props) {
            props.theme = _1.useTheme(props.theme);
            var direction = props.theme.direction;
            var maybeFlip = direction === _1.ContentDirection.RTL ? rtl_css_js_1.default : noop;
