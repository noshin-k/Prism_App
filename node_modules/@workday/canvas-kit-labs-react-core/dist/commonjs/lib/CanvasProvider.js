...
var CanvasProvider = (function (_super) {
    ...
    CanvasProvider.prototype.render = function () {
        ...
        return (React.createElement(emotion_theming_1.ThemeProvider, { theme: theme },
            React.createElement(DirectionContainer, { dir: theme.direction },
                React.createElement(canvas_kit_react_core_1.InputProvider, null, children))));
    };
    CanvasProvider.defaultProps = {
        theme: theme_1.defaultCanvasTheme,
    };
    return CanvasProvider;
}(React.Component));
exports.default = CanvasProvider;
