...
var Container = /*#__PURE__*/(0, _styledBase2.default)('div', {
    target: 'e12u9c0e0',
    label: 'Container'
})((_a = {}, _a["." + _IconButton.iconButtonIdentifier] = {
    borderRadius: _canvasKitReactCore.borderRadius.zero,
    borderWidth: '1px',
    marginLeft: '-1px',
    '&:first-child': {
        borderTopLeftRadius: _canvasKitReactCore.spacing.xxxs,
        borderBottomLeftRadius: _canvasKitReactCore.spacing.xxxs,
        marginLeft: 0
    },
    '&:last-child': {
        borderTopRightRadius: _canvasKitReactCore.spacing.xxxs,
        borderBottomRightRadius: _canvasKitReactCore.spacing.xxxs
    },
    '&:focus': {
        borderRadius: _canvasKitReactCore.spacing.xxxs,
        zIndex: 1,
        animation: 'none',
...
var IconButtonToggleGroup = function (_super) {
    ...
    function IconButtonToggleGroup() {
        ...
        _this.renderChild = function (child, index) {
            if (typeof child.type === typeof _IconButton2.default) {
...
exports.default = IconButtonToggleGroup;