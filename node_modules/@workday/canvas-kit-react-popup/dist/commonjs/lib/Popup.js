...
var Container = styled_1.default('div', {
    shouldForwardProp: function (prop) { return is_prop_valid_1.default(prop) && prop !== 'width'; },
})({
    position: 'relative',
    maxWidth: "calc(100vw - " + canvas_kit_react_core_1.spacing.l + ")",
}, function (_a) {
    var width = _a.width;
    ...
    Popup.prototype.render = function () {
        ...
        return (React.createElement(Container, __assign({ transformOrigin: transformOrigin, width: width, role: "dialog", "aria-labelledby": heading ? this.id : undefined, ref: popupRef }, elemProps),
            handleClose && (React.createElement(CloseIconContainer, { closeIconSize: closeIconSize },
                React.createElement(canvas_kit_react_button_1.IconButton, { "data-close": "close", ref: this.closeButtonRef, variant: canvas_kit_react_button_1.IconButton.Variant.Plain, size: closeIconSize, onClick: handleClose, icon: canvas_system_icons_web_1.xIcon, "aria-label": closeLabel }))),
            React.createElement(canvas_kit_react_card_1.default, { depth: depth, heading: heading, headingId: heading ? this.id : undefined, width: "100%", padding: padding }, this.props.children)));
    };
