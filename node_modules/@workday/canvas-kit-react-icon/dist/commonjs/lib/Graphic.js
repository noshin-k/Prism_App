...
exports.graphicStyles = function (_a) {
...
var Graphic = (function (_super) {
    ...
    Graphic.prototype.render = function () {
        ...
        return (React.createElement(Svg_1.default, { src: src, styles: exports.graphicStyles({ width: width, height: height, grow: grow }), type: design_assets_types_1.CanvasIconTypes.Graphic, elemProps: elemProps }));
    };
    return Graphic;
}(React.Component));
