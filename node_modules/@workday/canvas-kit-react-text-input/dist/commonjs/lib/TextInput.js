...
var Input = canvas_kit_labs_react_core_1.styled('input')(__assign({}, canvas_kit_react_core_1.type.body, { border: "1px solid " + canvas_kit_react_core_1.inputColors.border, display: 'block', backgroundColor: canvas_kit_react_core_1.inputColors.background, borderRadius: canvas_kit_react_core_1.borderRadius.m, boxSizing: 'border-box', height: 40, transition: '0.2s box-shadow, 0.2s border-color', padding: canvas_kit_react_core_1.spacingNumbers.xxs, margin: 0, '&::placeholder': {
    ...
    return __assign({ '&:focus:not([disabled])': {
            ...
            outline: 'none',
        } }, canvas_kit_react_common_1.errorRing(error, theme));
});
var TextInput = (function (_super) {
    ...
    TextInput.ErrorType = canvas_kit_react_common_1.ErrorType;
