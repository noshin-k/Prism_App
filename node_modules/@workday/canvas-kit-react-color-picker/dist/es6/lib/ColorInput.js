...
import { styled, ContentDirection } from '@workday/canvas-kit-labs-react-core';
...
var CustomHexInput = styled(TextInput)(__assign({ boxSizing: 'border-box', minWidth: colorInputWidth, width: colorInputWidth }, type.variant.mono, { '&:focus::placeholder': {
        color: 'transparent',
    } }), function (_a) {
    var grow = _a.grow;
    return grow && {
...
var PoundSignPrefix = styled('span')(__assign({ position: 'absolute', top: 10 }, type.body, type.variant.mono), function (_a) {
    var disabled = _a.disabled;
    return ({
