...
var ActionBarContainer = styled_1.default('div')({
    borderTop: "solid 1px " + canvas_kit_react_core_1.colors.soap400,
    background: canvas_kit_react_core_1.commonColors.background,
    padding: canvas_kit_react_core_1.spacing.s,
    boxShadow: '0 -2px 4px rgba(0, 0, 0, 0.08)',
    '@media (max-width: 575px)': {
        padding: canvas_kit_react_core_1.spacing.xxs,
    },
}, function (_a) {
    var fixed = _a.fixed;
    return fixed && {
